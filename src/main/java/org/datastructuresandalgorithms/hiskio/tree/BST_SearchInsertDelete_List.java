...
/**
 * https://hiskio.com/courses/434/lectures/22284
 */

/**
 * 使用 list 實作 binary search tree 的 search, insert, delete
 */
public class BST_SearchInsertDelete_List {
    ...
    public BST_SearchInsertDelete_List(int[] nums) {
        this.nums = nums;
    }
    ...
    private BST_Node add(BST_Node node, int val) {
        ...
        if (val == node.val) {
            System.out.println("node already exists. no need to add again");
        }
        // 如果小於 node 往左走
