...
public class Graph_Adj_List_Impl_EdgeState_Vertex {
    ...
    public Graph_Adj_List_Impl_EdgeState_Vertex(int num_of_vertex) {
    ...
    public static void main(String[] args) {
        Graph_Adj_List_Impl_EdgeState_Vertex graph = new Graph_Adj_List_Impl_EdgeState_Vertex(5);
